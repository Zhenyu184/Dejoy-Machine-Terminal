...
char remote_IP[] = "192.168.9.147";
char remote_Port[] = "8087";
char local_Port[] = "1112";
char s[50]="";
char buf[100] = {0} ;
char rbuf[100] = {0} ;
...
int main() {
	...
	sendCMD("AT+CIFSR","OK");
	sprintf(s,"AT+CIPSTART=\"UDP\",\"%s\",%s,%s,0",remote_IP,remote_Port,local_Port);
	sendCMD(s,"OK",10000);
